...
import com.miansad.chatsapp.R;
import com.miansad.chatsapp.databinding.ActivityMainBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFirebaseRemoteConfig.fetchAndActivate().addOnSuccessListener(new OnSuccessListener<Boolean>() {
            ...
            public void onSuccess(Boolean aBoolean) {
                ...
                Log.d("Config", "OnImage: " + backgroundImage);
                ...
                Log.d("Config", "OnImage: " + toolbarColor);
                Log.d("Config", "OnImage: " + toolBarImage);
                Log.d("Config", "OnImage: " + isToolBarImageEnabled);
